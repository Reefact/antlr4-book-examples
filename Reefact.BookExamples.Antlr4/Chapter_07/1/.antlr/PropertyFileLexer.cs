...
public partial class PropertyFileLexer : Lexer {
	...
	public PropertyFileLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public PropertyFileLexer(ICharStream input, TextWriter output, TextWriter errorOutput)

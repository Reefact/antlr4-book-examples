...
public partial class VecMsgParser : Parser {
	...
	static VecMsgParser() {
		...
		public VecMsgParser(ITokenStream input) : this(input, Console.Out, Console.Error) { }

		public VecMsgParser(ITokenStream input, TextWriter output, TextWriter errorOutput)
	...
	public partial class Vec4Context : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			IVecMsgListener typedListener = listener as IVecMsgListener;
	...
	public partial class IntsContext : ParserRuleContext {
		public int max;
		public int i = 1;
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode[] INT() { return GetTokens(VecMsgParser.INT); }
	...
	public IntsContext ints(int max) {
		...
		try {
			...
			while (_la==T__2) {
				...
				_localctx.i++;
				State = 11;
				if (!(_localctx.i<=_localctx.max)) throw new FailedPredicateException(this, "$i<=$max", "exceed max "+_localctx.max);
				State = 12;
				Match(INT);
				}
				}

...
public partial class ActionExprLexer : Lexer {
	...
	public ActionExprLexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public ActionExprLexer(ICharStream input, TextWriter output, TextWriter errorOutput)

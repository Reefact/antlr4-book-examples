...
public partial class Cymbol_8_3Parser : Parser {
	...
	static Cymbol_8_3Parser() {
		...
		public Cymbol_8_3Parser(ITokenStream input) : this(input, Console.Out, Console.Error) { }

		public Cymbol_8_3Parser(ITokenStream input, TextWriter output, TextWriter errorOutput)
	...
	public partial class FileContext : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			ICymbol_8_3Listener typedListener = listener as ICymbol_8_3Listener;
	...
	public partial class VarDeclContext : ParserRuleContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode ID() { return GetToken(Cymbol_8_3Parser.ID, 0); }
	...
	public partial class IntContext : ExprContext {
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode INT() { return GetToken(Cymbol_8_3Parser.INT, 0); }
	...
	private static int[] _serializedATN = {
		...
		1,0,0,0,14,88,1,0,0,0,16,107,1,0,0,0,18,128,1,0,0,0,20,23,3,6,3,0,21,23,
		...
		6,0,0,93,95,3,18,9,0,94,93,1,0,0,0,94,95,1,0,0,0,95,96,1,0,0,0,96,108,
		5,7,0,0,97,98,5,17,0,0,98,108,3,16,8,8,99,100,5,18,0,0,100,108,3,16,8,
		7,101,108,5,22,0,0,102,108,5,23,0,0,103,104,5,6,0,0,104,105,3,16,8,0,105,
		106,5,7,0,0,106,108,1,0,0,0,107,90,1,0,0,0,107,97,1,0,0,0,107,99,1,0,0,
		0,107,101,1,0,0,0,107,102,1,0,0,0,107,103,1,0,0,0,108,125,1,0,0,0,109,
		110,10,6,0,0,110,111,5,19,0,0,111,124,3,16,8,7,112,113,10,5,0,0,113,114,
		7,1,0,0,114,124,3,16,8,6,115,116,10,4,0,0,116,117,5,21,0,0,117,124,3,16,
		8,5,118,119,10,9,0,0,119,120,5,15,0,0,120,121,3,16,8,0,121,122,5,16,0,
		0,122,124,1,0,0,0,123,109,1,0,0,0,123,112,1,0,0,0,123,115,1,0,0,0,123,
		118,1,0,0,0,124,127,1,0,0,0,125,123,1,0,0,0,125,126,1,0,0,0,126,17,1,0,
		...
		1,0,0,0,135,133,1,0,0,0,14,22,24,30,40,50,60,73,77,88,94,107,123,125,133
	};

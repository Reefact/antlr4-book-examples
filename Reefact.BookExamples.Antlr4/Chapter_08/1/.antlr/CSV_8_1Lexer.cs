...
public partial class CSV_8_1Lexer : Lexer {
	...
	public CSV_8_1Lexer(ICharStream input)
	: this(input, Console.Out, Console.Error) { }

	public CSV_8_1Lexer(ICharStream input, TextWriter output, TextWriter errorOutput)
